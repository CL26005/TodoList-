...
import test.GUI;
    ...
    public class SimpleTaskManager {
        ...
        static void privateAddTask(String recurring) {
            ...
            //  id = tasks length + 1
            Integer idCount = 1;
            idCount = tasks.size() + 1;
            String id = idCount.toString();
            //  dependency is empty at start = ""
            //                                                                                              Recurrance  id  Dependencies
            String[] task = {title, description, dueDate.toString(), category, priorityLevel, "Incomplete", "None",     id, "|"};
            tasks.add(task);
        ...
        static void markTaskAsComplete() {
            ...
            if (taskNumber >= 0 && taskNumber < tasks.size()) {
                tasks.get(taskNumber)[5] = "Complete"; 
                System.out.println("Task \"" + tasks.get(taskNumber)[0] + "\" marked as complete!");

                if (tasks.get(taskNumber)[6].equals("true"))
                    isRecurring(taskNumber);
        ...
        static void taskDependencies() {
            ...
            while (true) {
                ...
                int dependentTaskNumber = Integer.parseInt(scanner.nextLine()) - 1;

                if (dependentTaskNumber < 0 || dependentTaskNumber >= tasks.size()) {
                    System.out.println("Invalid task number! Please try again.");
                    continue;
                }

                System.out.print("Enter the task number it depends on: ");
                int precedingTaskNumber = Integer.parseInt(scanner.nextLine()) - 1;

                if (precedingTaskNumber < 0 || precedingTaskNumber >= tasks.size()) {
                    System.out.println("Invalid task number! Please try again.");
                    continue;
                }

                if (dependentTaskNumber == precedingTaskNumber) {
                ...
                // Add the dependency
                String[] task = tasks.get(dependentTaskNumber);
                ...
                System.out.println("Task \"" + tasks.get(dependentTaskNumber)[0] + "\" now depends on \"" + tasks.get(precedingTaskNumber)[0] + "\".");
                break;
            }
        }
        ...
        static void markTask() {
            ...
            while (notValid) {
                ...
                try {
                    ...
                    if (taskDependencies.containsKey(taskNumber)) {
                        for (int dependentTask : taskDependencies.get(taskNumber)) {
                            if (tasks.get(dependentTask)[2].equals("Incomplete")) {
                                System.out.println("\nWarning: Task \"" + tasks.get(taskNumber)[0] +
                    ...
                    tasks.get(taskNumber)[2] = "Complete";
                    System.out.println("Task \"" + tasks.get(taskNumber)[0] + "\" marked as complete!");
        ...
        static void editTask(){
            ...
            switch(edit){
                case 1 -> { 
                    ...
                    System.out.println("\nTask \"" + tasks.get(num)[0] + "\" has been updated to \"" + newTitle + ".\"");
                ...
                case 2 -> { 
                    ...
                    System.out.println("\nTask \"" + tasks.get(num)[1] + "\" has been updated to \"" + newDesc + ".\"");
                ...
                case 3 -> {
                    ...
                    while (!validDate) {
                        try {
                            ...
                            System.out.println("\nTask \"" + tasks.get(num)[2] + "\" has been updated to \"" + newDueDate + ".\"");
                ...
                case 4 -> { 
                    ...
                    System.out.println("\nTask \"" + tasks.get(num)[3] + "\" has been updated to \"" + newCat + ".\"");
                ...
                case 5 -> { 
                    ...
                    while (!validPriorityLevel) {
                        ...
                        newPri.toLowerCase();
                        System.out.println("\nTask \"" + tasks.get(num)[4] + "\" has been updated to \"" + newPri + ".\"");
                        tasks.get(num)[4] = newPri;
